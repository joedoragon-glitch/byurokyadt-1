const CACHE='byurokyadt-v10-1';
const CORE=[
 './','./index.html','./styles.css?v=10.1','./manifest.webmanifest','./icons/icon.svg',
 './js/cinematic.js?v=10.1','./js/app.js?v=10.1','./vendor/three.min.js',
 './assets/enamel-v9.webp','./js/audio.js?v=10.1',
