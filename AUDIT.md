...
- The production path passes 116,885 sampled vertex-clearance checks, arc-length checks and stamp registration. Existing camera checks pass 64 routes / 10,604 samples.
- A new browser gate records nine rendered intermediate views and checks the actual sheet geometry, stamp timing, door approach, source positions, cooldown and mute. Browser/visual results are recorded after review.
